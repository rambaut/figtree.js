(function (global, factory) {
	...
	/*#__PURE__*/
	function (_Bauble3) {
	  inherits(RoughCircleBauble, _Bauble3);
	  ...
	  createClass(RoughCircleBauble, [{
	    ...
	    value: function createShapes(selection) {
	      ...
	      addedNode.selectAll("path").each(function (d, i) {
	        if (i === 0) {
	          d3.select(this).attr("class", "roughjs rough-fill");
	        } else {
	          d3.select(this).attr("class", "roughjs rough-stroke");
	        }
	      });
	      return addedNode;
	    }
