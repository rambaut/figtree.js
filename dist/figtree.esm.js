      ...
      return selection.selectAll("path").data(function (d) {
        ...
        return enter.append("path").attr("d", function (c) {
          ...
          return Object.keys(attributes).reduce(function (acc, curr) {
            ...
            return _objectSpread$4({}, acc, defineProperty({}, curr, attributes[curr](c)));
          }, {});
        }).styles(function (c) {
          var styles = _this.settings.styles;
          return Object.keys(styles).reduce(function (acc, curr) {
            // const vertex = d3.select(n[i].parentNode).datum(); // the vertex data is assigned to the group
            return _objectSpread$4({}, acc, defineProperty({}, curr, styles[curr](c)));
          }, {});
        });
      }, function (update) {
        return update.call(function (update) {
...
function (_AbstractLayout) {
  ...
  function GeoLayout(tree, projection) {
    ...
    _this = possibleConstructorReturn(this, getPrototypeOf(GeoLayout).call(this, tree, _objectSpread$5({}, GeoLayout.DEFAULT_SETTINGS(), {}, settings)));
...
function () {
  ...
  function FigTree() {
    ...
    var layout = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : rectangularLayout;
      ...
      return function (data) {
        ...
        svgLayer.selectAll(".".concat(elementClass)).data(data, function (d) {
          ...
          return enter.append("g").attr("id", function (d) {
            ...
            return "translate(".concat(_this3.scales.x(d.x), ", ").concat(_this3.scales.y(d.y), ")");
          }).each(function (d) {
            ...
            if (elementClass === "branch") {
              return (_this3.scales.x(d.textLabel.dx[0]) - _this3.scales.x(d.textLabel.dx[1])) / 2;
            } else {
          ...
          return update.call(function (update) {
            return update.transition().duration(_this3.settings.transition.transitionDuration).ease(_this3.settings.transition.transitionEase).attr("class", function (d) {
              return ["".concat(elementClass)].concat(toConsumableArray(d.classes)).join(" ");
            }).attr("transform", function (d) {
              return "translate(".concat(_this3.scales.x(d.x), ", ").concat(_this3.scales.y(d.y), ")");
            }).each(function (d) {
            ...
            }).select(".".concat(elementClass, "-label")).transition().duration(_this3.settings.transition.transitionDuration).ease(_this3.settings.transition.transitionEase).attr("text-anchor", function (d) {
              return d.textLabel.textAnchor;
            }).attr("alignment-baseline", function (d) {
              return d.textLabel.alignmentBaseline;
            }).attr("dx", function (d) {
...
function (_AbstractLayout) {
  ...
  function RootToTipPlot(tree) {
    ...
    return possibleConstructorReturn(this, getPrototypeOf(RootToTipPlot).call(this, tree, _objectSpread$7({
      externalNodeLabelAnnotationName: null,
    ...
    value: function update(selection) {
      ...
      return selection.selectAll("rect").data(function (d) {
        ...
        return enter.append("rect").attr("x", -w / 2).attr("width", w).attr("y", -h / 2).attr("height", h).attr("rx", _this.settings.radius).attr("ry", _this.settings.radius).attr("class", "node-shape").attrs(function (vertex) {
          ...
          return Object.keys(attributes).reduce(function (acc, curr) {
            // const vertex = d3.select(n[i].parentNode).datum(); // the vertex data is assigned to the group
            return _objectSpread$8({}, acc, defineProperty({}, curr, attributes[curr](vertex)));
          }, {});
        }).styles(function (vertex) {
          var styles = _this.settings.styles;
          return Object.keys(styles).reduce(function (acc, curr) {
            // const vertex = d3.select(n[i].parentNode).datum(); // the vertex data is assigned to the group
            return _objectSpread$8({}, acc, defineProperty({}, curr, styles[curr](vertex)));
          }, {});
        });
      }, function (update) {
        return update.call(function (update) {
    ...
    value: function update(selection) {
      ...
      return selection.selectAll("path").data(function (d) {
        ...
        return enter.append("path").attr("d", function (d, i) {
          ...
          return Object.keys(attributes).reduce(function (acc, curr) {
            return _objectSpread$9({}, acc, defineProperty({}, curr, attributes[curr](vertex)));
          }, {});
        }).styles(function (vertex, i, n) {
          var styles = _this.settings.styles[pathNames[i]];
          return Object.keys(styles).reduce(function (acc, curr) {
            return _objectSpread$9({}, acc, defineProperty({}, curr, styles[curr](vertex)));
          }, {});
        });
      }, function (update) {
        return update.call(function (update) {
    ...
    value: function update(selection) {
      ...
      return selection.selectAll("path").data(function (d) {
        ...
        return enter.append("path").attr("d", function (edge) {
          ...
          return Object.keys(attributes).reduce(function (acc, curr) {
            // const vertex = d3.select(n[i].parentNode).datum(); // the vertex data is assigned to the group
            return _objectSpread$a({}, acc, defineProperty({}, curr, attributes[curr](edge)));
          }, {});
        }).styles(function (edge) {
          var styles = _this2.settings.styles;
          return Object.keys(styles).reduce(function (acc, curr) {
            // const vertex = d3.select(n[i].parentNode).datum(); // the vertex data is assigned to the group
            return _objectSpread$a({}, acc, defineProperty({}, curr, styles[curr](edge)));
          }, {});
        });
      }, function (update) {
        return update.call(function (update) {
...
function (_AbstractLayout) {
  ...
  function EqualAngleLayout(tree) {
    ...
    _this = possibleConstructorReturn(this, getPrototypeOf(EqualAngleLayout).call(this, tree, _objectSpread$b({
      fixedOrder: true
...
export { Axis, Bauble, Branch, CircleBauble, EqualAngleLayout, ExplodedLayout, FigTree, GeoLayout, GreatCircleBranchBauble, RectangularBauble, RectangularLayout, RootToTipPlot, RoughBranchBauble, RoughCircleBauble, TransmissionLayout, Tree, Type, branches, equalAngleLayout, nodeBackground, nodes, rectangularLayout };
