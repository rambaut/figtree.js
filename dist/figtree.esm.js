...
class FigTree {
    ...
    constructor(svg, layout, margins, settings = {}) {
        ...
        this.roughSvg = rough_umd.svg(this.svg);
...
export { Bauble, CircleBauble, ExplodedLayout, FigTree, RectangularBauble, RectangularLayout, RootToTipPlot, TransmissionLayout, Tree, Type };
