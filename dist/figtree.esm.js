  ...
  createClass(AbstractLayout, [{
    ...
    *
    ...
    get: function get() {
      ...
      return extent(this._vertices, function (d) {
        return d.y;
      });
    }
  }, {
...
function (_AbstractLayout) {
  ...
  function GeoLayout(tree, projection) {
    ...
    _this = possibleConstructorReturn(this, getPrototypeOf(GeoLayout).call(this, tree, _objectSpread$2({}, GeoLayout.DEFAULT_SETTINGS(), {}, settings)));
...
function () {
  ...
  createClass(FigTree, [{
    ...
    value: function transitions() {
      ...
      if (t) {
        this._transitions = _objectSpread$3({}, this._transitions, {}, t);
      } else {
        return this._transitions;
      }
    }
    ...
    value: function margins() {
      ...
      if (m !== null) {
        this._margins = _objectSpread$3({}, this._margins, {}, m);
        return this;
      } else {
...
var AbstractNodeBauble =
/*#__PURE__*/
function (_Bauble) {
  inherits(AbstractNodeBauble, _Bauble);

  function AbstractNodeBauble() {
    classCallCheck(this, AbstractNodeBauble);

    return possibleConstructorReturn(this, getPrototypeOf(AbstractNodeBauble).call(this));
  }
  /**
  ...
  createClass(AbstractNodeBauble, [{
    key: "hilightOnHover",
    value: function hilightOnHover() {
      var _this = this;

      get$2(getPrototypeOf(AbstractNodeBauble.prototype), "on", this).call(this, "mouseenter", function (d, i, n) {
      ...
      get$2(getPrototypeOf(AbstractNodeBauble.prototype), "on", this).call(this, "mouseleave", function (d, i, n) {
        var parent = select(n[i]).node().parentNode;
    ...
    value: function annotateOnHover(key) {
      ...
      get$2(getPrototypeOf(AbstractNodeBauble.prototype), "on", this).call(this, "mouseenter", function (d, i, n) {
        _this2.manager().figure()[p.tree].annotateNode(_this2.manager().figure()[p.tree].getNode(d.id), defineProperty({}, key, true));
      ...
      get$2(getPrototypeOf(AbstractNodeBauble.prototype), "on", this).call(this, "mouseleave", function (d, i, n) {
        _this2.manager().figure()[p.tree].annotateNode(_this2.manager().figure()[p.tree].getNode(d.id), defineProperty({}, key, false));
    ...
    value: function rotateOnClick() {
      ...
      get$2(getPrototypeOf(AbstractNodeBauble.prototype), "on", this).call(this, "click", function (d, n, i) {
        var node = _this3.manager().figure()[p.tree].getNode(d.key);

        _this3.manager().figure()[p.tree].rotate(node, recursive);
      });
    ...
    value: function annotateOnClick(key) {
      ...
      get$2(getPrototypeOf(AbstractNodeBauble.prototype), "on", this).call(this, "click", function (d, i, n) {
        var node = _this4.manager().figure()[p.tree].getNode(d.id); //TODO helper getters


        _this4.manager().figure()[p.tree].annotateNode(node, defineProperty({}, key, !node.annotations[key]));
...
function (_AbstractNodeBauble) {
  inherits(CircleBauble, _AbstractNodeBauble);
...
/*#__PURE__*/
function (_AbstractNodeBauble) {
  inherits(RectangularBauble, _AbstractNodeBauble);
...
function rectangularVertices(tree) {
  ...
  var traverse = function traverse(node) {
    ...
    if (node.children) {
      ...
      var vertex = _objectSpread$4({}, makeVertexFromNode(node), {
      ...
      var _vertex = _objectSpread$4({}, makeVertexFromNode(node), {
        y: currentY,
        x: node.divergence
      });
...
/*#__PURE__*/
function (_Decoration) {
  inherits(AxisBars, _Decoration);

  function AxisBars(axis) {
    var _this;

    classCallCheck(this, AxisBars);

    _this = possibleConstructorReturn(this, getPrototypeOf(AxisBars).call(this));

    get$2(getPrototypeOf(AxisBars.prototype), "layer", assertThisInitialized(_this)).call(assertThisInitialized(_this), "axes-layer");
  ...
  createClass(AxisBars, [{
    ...
    value: function updateCycle() {
      ...
      }).attr("height", this.figure().scales.height).attr("y", -1 * this.figure().scales.height);
    }
  }]);
...
function (_AbstractNodeBauble) {
  ...
  function RoughCircleBauble() {
    ...
    _this = possibleConstructorReturn(this, getPrototypeOf(RoughCircleBauble).call(this));
    _this._fillAttrs = {
      stroke: "black",
      "stroke-width": 1,
      fill: "none"
...
/*#__PURE__*/
function (_Branch) {
  inherits(RoughBranchBauble, _Branch);
  ...
  function RoughBranchBauble(settings) {
    ...
    _this = possibleConstructorReturn(this, getPrototypeOf(RoughBranchBauble).call(this));
    _this._roughSettings = {};
    return _this;
  }
  /**
  ...
  createClass(RoughBranchBauble, [{
    ...
    value: function setup() {
      ...
      this.branchPath = function (edge) {
        ...
        return toConsumableArray(roughFactory.path(basicPath, _this2.settings).childNodes).map(function (d) {
          return d.getAttribute("d");
        })[0];
      };
    }
    ...
    value: function branchPathGenerator() {
      ...
      var basicPathGenerator = get$2(getPrototypeOf(RoughBranchBauble.prototype), "branchPathGenerator", this).call(this);

      var branchPath = function branchPath(edge) {
        var basicPath = basicPathGenerator(edge);
        return toConsumableArray(roughFactory.path(basicPath, _this3._roughSettings).childNodes).map(function (d) {
          return d.getAttribute("d");
        })[0];
      };
...
export { Bauble, BaubleManager, Branch, CircleBauble, Decoration, FigTree, RectangularBauble, Tree, Type, axis$1 as axis, axisBars, branch, branchLabel, branches, circle, decimalToDate, equalAngleLayout, internalNodeLabel, label, legend, nodeBackground, nodes, rectangle, rectangularHilightedLayout, rectangularLayout, rootToTipLayout, roughBranch, roughCircle, scaleBar, tipLabel };
