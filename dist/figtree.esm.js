...
function () {
  ...
  createClass(FigTree, [{
    ...
    value: function transitions() {
      ...
      if (t) {
        this._transitions = _objectSpread$7({}, this._transitions, {}, t);
      } else {
        return this._transitions;
      }
    }
    ...
    value: function margins() {
      ...
      if (m) {
        this._margins = _objectSpread$7({}, this._margins, {}, m);
        return this;
      } else {
        return this_margins;
      }
...
function (_AbstractLayout) {
  ...
  function RootToTipPlot(tree) {
    ...
    return possibleConstructorReturn(this, getPrototypeOf(RootToTipPlot).call(this, tree, _objectSpread$8({
      externalNodeLabelAnnotationName: null,
    ...
    value: function update(selection) {
      ...
      return selection.selectAll("path").data(function (d) {
        ...
        return enter.append("path").attr("d", function (edge) {
          ...
          return Object.keys(attributes).reduce(function (acc, curr) {
            // const vertex = d3.select(n[i].parentNode).datum(); // the vertex data is assigned to the group
            return _objectSpread$b({}, acc, defineProperty({}, curr, attributes[curr](edge)));
          }, {});
        }).styles(function (edge) {
          var styles = _this2.settings.styles;
          return Object.keys(styles).reduce(function (acc, curr) {
            // const vertex = d3.select(n[i].parentNode).datum(); // the vertex data is assigned to the group
            return _objectSpread$b({}, acc, defineProperty({}, curr, styles[curr](edge)));
          }, {});
        });
      }, function (update) {
        return update.call(function (update) {
...
function (_AbstractLayout) {
  ...
  function EqualAngleLayout(tree) {
    ...
    _this = possibleConstructorReturn(this, getPrototypeOf(EqualAngleLayout).call(this, tree, _objectSpread$c({
      fixedOrder: true
  ...
  createClass(AxisFactory, [{
    ...
    value: function title() {
      ...
      if (!options) {
        ...
        this._title = _objectSpread$e({}, this._title, {}, options);
        return this;
      }
    }
  }, {
...
export { Axis, Bauble, Branch, CircleBauble, EqualAngleLayout, ExplodedLayout, FigTree, GeoLayout, GreatCircleBranchBauble, RectangularBauble, RectangularLayout, RootToTipPlot, RoughBranchBauble, RoughCircleBauble, TransmissionLayout, Tree, Type, axis$1 as axis, branches, decimalToDate, equalAngleLayout, nodeBackground, nodes, rectangularLayout, rootToTipLayout };
