...
function (_BaubleManager) {
  inherits(BranchFactory, _BaubleManager);
  ...
  createClass(BranchFactory, [{
    ...
    value: function reRootOnClick() {
      ...
      get$2(getPrototypeOf(BranchFactory.prototype), "on", this).call(this, "click", function (branch) {
        return function (d, i, n) {
          var x1 = _this2.scales().x(d.v1.x),
              x2 = _this2.scales().x(d.v0.x),
              y1 = _this2.scales().y(d.v1.y),
              y2 = _this2.scales().y(d.v0.y),
...
var branches$1 = function branches() {
  return new BranchFactory()["class"]("branch").data(function (d) {
    return d["edges"];
  }).layer("branches-layer");
};
...
function () {
  ...
  createClass(FigTree, [{
    ...
    value: function transitions() {
      ...
      if (t) {
        this._transitions = _objectSpread$8({}, this._transitions, {}, t);
      } else {
        return this._transitions;
      }
    }
    ...
    value: function margins() {
      ...
      if (m) {
        this._margins = _objectSpread$8({}, this._margins, {}, m);
        return this;
      } else {
        return this_margins;
      }
    ...
    key: "nodeBackground",
    value: function nodeBackground$1() {
      var n = nodeBackground();
...
function (_AbstractLayout) {
  ...
  function RootToTipPlot(tree) {
    ...
    return possibleConstructorReturn(this, getPrototypeOf(RootToTipPlot).call(this, tree, _objectSpread$9({
      externalNodeLabelAnnotationName: null,
    ...
    value: function update(selection) {
      ...
      return selection.selectAll("rect").data(function (d) {
        ...
        return enter.append("rect").attr("x", -w / 2).attr("width", w).attr("y", -h / 2).attr("height", h).attr("rx", _this.settings.radius).attr("ry", _this.settings.radius).attr("class", "node-shape").attrs(function (vertex) {
          ...
          return Object.keys(attributes).reduce(function (acc, curr) {
            // const vertex = d3.select(n[i].parentNode).datum(); // the vertex data is assigned to the group
            return _objectSpread$a({}, acc, defineProperty({}, curr, attributes[curr](vertex)));
          }, {});
        }).styles(function (vertex) {
          var styles = _this.settings.styles;
          return Object.keys(styles).reduce(function (acc, curr) {
            // const vertex = d3.select(n[i].parentNode).datum(); // the vertex data is assigned to the group
            return _objectSpread$a({}, acc, defineProperty({}, curr, styles[curr](vertex)));
          }, {});
        });
      }, function (update) {
        return update.call(function (update) {
    ...
    value: function update(selection) {
      ...
      return selection.selectAll("path").data(function (d) {
        ...
        return enter.append("path").attr("d", function (d, i) {
          ...
          return Object.keys(attributes).reduce(function (acc, curr) {
            return _objectSpread$b({}, acc, defineProperty({}, curr, attributes[curr](vertex)));
          }, {});
        }).styles(function (vertex, i, n) {
          var styles = _this.settings.styles[pathNames[i]];
          return Object.keys(styles).reduce(function (acc, curr) {
            return _objectSpread$b({}, acc, defineProperty({}, curr, styles[curr](vertex)));
          }, {});
        });
      }, function (update) {
        return update.call(function (update) {
    ...
    value: function update(selection) {
      ...
      return selection.selectAll("path").data(function (d) {
        ...
        return enter.append("path").attr("d", function (edge) {
          ...
          return Object.keys(attributes).reduce(function (acc, curr) {
            // const vertex = d3.select(n[i].parentNode).datum(); // the vertex data is assigned to the group
            return _objectSpread$c({}, acc, defineProperty({}, curr, attributes[curr](edge)));
          }, {});
        }).styles(function (edge) {
          var styles = _this2.settings.styles;
          return Object.keys(styles).reduce(function (acc, curr) {
            // const vertex = d3.select(n[i].parentNode).datum(); // the vertex data is assigned to the group
            return _objectSpread$c({}, acc, defineProperty({}, curr, styles[curr](edge)));
          }, {});
        });
      }, function (update) {
        return update.call(function (update) {
...
function (_AbstractLayout) {
  ...
  function EqualAngleLayout(tree) {
    ...
    _this = possibleConstructorReturn(this, getPrototypeOf(EqualAngleLayout).call(this, tree, _objectSpread$d({
      fixedOrder: true
...
var rootToTipVertices = function rootToTipVertices(tree) {
  ...
  return tree.externalNodes.map(function (n) {
    return _objectSpread$e({}, makeVertexFromNode(n), {
